...
vips_yDNA[8, 3] <- "Leopold IV, Margrave of Austria, aka Leopold I, Duke of Bavaria"
vips_yDNA[9, 3] <- "Henry II, Duke of Austria, aka Henry XI, also Duke of Bavaria"
...
vips_yDNA[14, 3] <- "Richard Baird"
vips_yDNA[15, 3] <- "William the Falconer"
vips_yDNA[16, 3] <- "Cospatric I Anglo-Danish Earl of Northumbria"
vips_yDNA[17, 3] <- "Earl of Home"
vips_yDNA[18, 3] <- "Thomas Laing"
vips_yDNA[19, 3] <- "Archibald Layng"
vips_yDNA[20, 3] <- "Clan MacDonald"
vips_yDNA[21, 3] <- "Clan MacDougall"
vips_yDNA[22, 3] <- "Ernulf de Swinton"
vips_yDNA[23, 3] <- "Olaf II of Denmark & Norway"
vips_yDNA[24, 3] <- "Christian I"
vips_yDNA[25, 3] <- "John"
vips_yDNA[26, 3] <- "Christian II"
vips_yDNA[27, 3] <- "Frederick I"
vips_yDNA[28, 3] <- "Christian III"
vips_yDNA[29, 3] <- "Frederick II"
vips_yDNA[30, 3] <- "Christian IV"
vips_yDNA[31, 3] <- "Frederick III"
vips_yDNA[32, 3] <- "Christian V"
vips_yDNA[33, 3] <- "Frederick IV"
vips_yDNA[34, 3] <- "Christian VI"
vips_yDNA[35, 3] <- "Frederick V"
vips_yDNA[36, 3] <- "Christian VII"
vips_yDNA[37, 3] <- "Frederick VI"
vips_yDNA[38, 3] <- "Christian VIII"
vips_yDNA[39, 3] <- "Frederick VII"
vips_yDNA[40, 3] <- "Christian IX"
vips_yDNA[41, 3] <- "Frederick VIII"
vips_yDNA[42, 3] <- "Christian X"
vips_yDNA[43, 3] <- "Frederick IX"
vips_yDNA[44, 3] <- "Richard III"
vips_yDNA[45, 3] <- "Prince Philip, Duke of Edinburgh"
vips_yDNA[46, 3] <- "Charles, Prince of Wales"
vips_yDNA[47, 3] <- "Prince William, Duke of Cambridge"
vips_yDNA[48, 3] <- "Birger Magnusson"
vips_yDNA[49, 3] <- "Erik, son of Birger"
vips_yDNA[50, 3] <- "Emperor Higashiyama"
vips_yDNA[51, 3] <- "Napoleon I"
...
vips_yDNA[82, 3] <- "Louis XVI Relic"
vips_yDNA[83, 3] <- "Henri IV Relic"
vips_yDNA[84, 3] <- "Fujiwara no Kamatari"
vips_yDNA[85, 3] <- "Sviatopolk I of Kiev"
vips_yDNA[86, 3] <- "George I"
vips_yDNA[87, 3] <- "Constantine I"
vips_yDNA[88, 3] <- "Alexander"
vips_yDNA[89, 3] <- "George II"
vips_yDNA[90, 3] <- "Rhys Gethin"
vips_yDNA[91, 3] <- "Haakon VI of Sweden & Norway"
vips_yDNA[92, 3] <- "Haakon VII"
vips_yDNA[93, 3] <- "Olav V"
vips_yDNA[94, 3] <- "Harald V"
vips_yDNA[95, 3] <- "Fath Ali Shah Qajar"
vips_yDNA[96, 3] <- "Borivoj I"
vips_yDNA[97, 3] <- "Spythinev"
vips_yDNA[98, 3] <- "Vratislaus"
vips_yDNA[99, 3] <- "Saint Wenceslaus"
vips_yDNA[100, 3] <- "Bolesalus I the Cruel"
vips_yDNA[101, 3] <- "Bolesalus II the Pious"
vips_yDNA[102, 3] <- "Boleslaus III the Red-haired"
vips_yDNA[103, 3] <- "Paul I"
vips_yDNA[104, 3] <- "Alexander I"
vips_yDNA[105, 3] <- "Constantine I"
vips_yDNA[106, 3] <- "Nicholas I"
vips_yDNA[107, 3] <- "Alexander II"
vips_yDNA[108, 3] <- "Alexander III"
vips_yDNA[109, 3] <- "Nicholas II"
vips_yDNA[110, 3] <- "Earl of Eglinton"
vips_yDNA[111, 3] <- "Somerled of Argyll"
vips_yDNA[112, 3] <- "Valdemar I of Sweden"
vips_yDNA[113, 3] <- "Magnus III of Sweden"
vips_yDNA[114, 3] <- "Birger I of Sweden"
